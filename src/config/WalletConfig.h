...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "PNET";
    ...
    const std::string daemonName = "Proximusd";

    /* The name to call this wallet */
    const std::string walletName = "ProximusWallet";
    ...
    const std::string contactLink = "http://proximus-pxs.com";
